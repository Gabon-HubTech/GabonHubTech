// components/HexagonCard.jsx (version suggérée)
"use client";
import { motion } from 'framer-motion';
import * as LucideIcons from 'lucide-react';

export default function HexagonCard({ title, subtitle, description, iconName }) {
  ...
  return (
    ...
    >
      {/* Forme Hexagonale en CSS ou SVG */}
      ...
      <div className="relative z-10 text-center p-6 flex flex-col items-center">
        ...
        <button className="mt-4 text-xs font-bold text-tech-blue uppercase tracking-widest hover:text-white transition-colors">
          En savoir plus →
        </button>
      </div>
    </motion.div>
